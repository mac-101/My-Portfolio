    ...
    <section id="library" className="py-20 px-4 bg-[#fafafa] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 reveal" data-animation="fade-up">
          ...
          <p className="pt-2">{portfolioProjects.length} Projects</p>
        </div>
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="mt-auto pt-6 border-t border-slate-50 flex flex-wrap gap-2">
                    {project.tags.map((tag, tagIndex) => (
                      <span key={`${tag}-${tagIndex}`} className="text-[9px] font-bold text-slate-400 uppercase tracking-widest border border-slate-200 px-2 py-1 rounded-md">
                        {tag}
                      </span>
                    ))}
                  </div>
